...
const followUpRules = [
  ...
  },
  {
    ...
    description:
      'Após o envio por WhatsApp, Messenger ou Direct, o follow-up permanece pendente como Aguardando resposta. Ele só é concluído quando o cliente responde.',
    icon: TimerReset,
    color: '#b45309',
    background: '#fffbeb',
  },
  {
    title: 'Uma resposta para vários follow-ups',
    description:
      'Quando existem vários follow-ups enviados e aguardando resposta no mesmo canal, a próxima mensagem do cliente é vinculada a todos eles e conclui esses follow-ups.',
    icon: MessageCircle,
    color: '#0f766e',
    background: '#f0fdfa',
  },
...
export default function InformacoesPage() {
  ...
  const [activeChannel, setActiveChannel] =
    useState<InformationChannel>('whatsapp')
      ...
      >
        ...
        >
          <section>
            ...
            >
              {isFollowUps
                ? 'Entenda como funcionam o envio, a espera pela resposta do cliente e a conclusão de cada tipo de follow-up.'
                : isWhatsApp
            ...
            <div>
              ...
              >
                {isFollowUps ? (
                  ...
                  <>
                    O template precisa ser aprovado previamente pela Meta e{' '}
                    <strong style={{ color: '#111827', fontWeight: 800 }}>
                      seu envio possui custo
                    </strong>
                    . Quando o cliente responder, a janela de atendimento de 24
                    horas será aberta e as mensagens livres serão liberadas.
                  </>
                ) : isDirect ? (
              ...
              {isFollowUps ? (
                <div style={{ marginTop: 14, display: 'grid' }}>
                  {[
                    {
                      channel: 'WhatsApp',
                      rule: 'Após o envio da mensagem ou template, o follow-up fica Aguardando resposta. A próxima resposta do cliente pelo WhatsApp conclui todos os follow-ups desse canal que estiverem aguardando.',
                    },
                    {
                      channel: 'Messenger',
                      rule: 'Envia somente dentro da janela de 24 horas e depois fica Aguardando resposta. A próxima resposta pelo Messenger conclui todos os follow-ups desse canal que estiverem aguardando.',
                    },
                    {
                      channel: 'Direct',
                      rule: 'Envia somente dentro da janela de 24 horas e depois fica Aguardando resposta. A próxima resposta pelo Direct conclui todos os follow-ups desse canal que estiverem aguardando.',
                    },
                    {
                      channel: 'E-mail',
                      rule: 'Pode ser enviado a qualquer momento e exige destinatário válido, assunto e conteúdo. O follow-up é concluído assim que o e-mail é enviado.',
                    },
                    {
                      channel: 'Agenda',
          ...
          {isFollowUps ? (
            ...
            >
              ...
              <div>
                ...
                >
                  Cada status indica a etapa atual do follow-up e qual evento
                  pode levá-lo ao próximo estado.
                </p>
                  ...
                  {[
                    {
                      title: 'Agendado',
                      description:
                        'Aparece desde a criação até o horário definido. Mensagens seguem para Aguardando resposta após o envio; e-mails seguem para Concluído; ações Agenda passam a Pendente ao vencer e aguardam a conclusão manual.',
                    },
                    {
                      title: 'Aguardando resposta',
                      description:
                        'Aparece após o envio por WhatsApp, Messenger ou Direct. Quando o cliente responde pelo mesmo canal, segue para Concluído.',
                    },
                    {
                      title: 'Ação manual',
                      description:
                        'Aparece quando Messenger ou Direct estão fora da janela de 24 horas. Permanece assim até o follow-up ser editado ou concluído manualmente.',
                    },
                    {
                      title: 'Falha no envio',
                      description:
                        'Aparece quando ocorre um erro durante o envio. Após corrigir os dados e editar o follow-up, uma nova tentativa pode colocá-lo novamente no fluxo.',
                    },
                    {
                      title: 'Concluído',
                      description:
                        'Estado final: mensagens chegam aqui após a resposta do cliente, e-mails após o envio e ações Agenda após a marcação manual.',
                    },
                    {
                      title: 'Cancelado ou Ignorado',
                      description:
                        'Estados finais definidos manualmente. A ação deixa de seguir o fluxo automático e não aguarda resposta.',
                    },
                  ].map((item) => (
                    <div
                      key={item.title}
          ...
          {isFollowUps ? (
            ...
            >
              ...
              <div>
                ...
                >
                  Recursos para acompanhar o que aconteceu depois do envio ou
                  antes do vencimento.
                </p>
                  ...
                  {[
                    {
                      ...
                      description:
                        'A resposta fica registrada no follow-up. Ao clicar nela, o Flow abre o chat diretamente nessa mensagem.',
                    },
                    {
                      title: 'Lembrete de 1 hora',
                      description:
                        'Quando essa notificação estiver habilitada, o Flow avisa uma vez sobre follow-ups pendentes que vencem na próxima hora.',
                    },
                  ].map((item) => (
                    <div
                      key={item.title}
